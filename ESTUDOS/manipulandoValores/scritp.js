...
function mudarCor1(){
    ...
    quadrado.setAttribute('style', 'background-color: rgba('+cor1Seletor+','+cor2atual+','+cor3atual+',0.500)')
    cor1 = cor1Seletor
}
...
function mudarCor2(){
    ...
    quadrado.setAttribute('style', 'background-color: rgba('+cor1atual+','+cor2Seletor+','+cor3atual+',0.500)')
    cor2 = cor2Seletor
}
...
function mudarCor3(){
    ...
    quadrado.setAttribute('style', 'background-color: rgba('+cor1atual+', '+cor2atual+','+cor3Seletor+',0.500)')
    cor3 = cor3Seletor
}
